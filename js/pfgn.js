var orderTableBody = document.getElementById('orderTableBody');
        ...
        products.forEach(function (product) {
            ...
            //含量
            var shopHL = document.createElement('td');
            shopHL.textContent = product.HanLiang;
            row.appendChild(shopHL);

            //箱价
            var boxPriceCell = document.createElement('td');
            boxPriceCell.textContent = product.price * product.HanLiang +'元';
            row.appendChild(boxPriceCell);
            ...
            function updateTotal() {
                ...
                var totalZ1 = product.price * product.HanLiang;
                var total = totalZ1 * quantity;
